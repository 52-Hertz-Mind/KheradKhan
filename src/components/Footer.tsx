function Footer(){
    return(
        <footer className='px-40 py-20 bg-gray-950 flex flex-col gap-10'>
            <div className='text-white flex flex-col gap-5' dir='rtl'>
                <p className='text-3xl' >خردخوان</p>
                <p> ما به هزاران خواننده کمک می کنیم تا از نکات برجسته دیجیتال خود بیشترین استفاده را ببرند.</p>
            </div>
